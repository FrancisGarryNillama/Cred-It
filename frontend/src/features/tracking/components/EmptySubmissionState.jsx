            ...
            <div className="relative bg-white/90 backdrop-blur-sm p-8 sm:p-10 md:p-12 rounded-2xl shadow-xl border border-gray-200/50">
                ...
                <div className="flex justify-center mb-6">
                    <div className="relative">
                        {/* Animated rings */}
                        <div className="absolute inset-0 bg-gradient-to-br from-blue-600 to-indigo-600 rounded-full blur-xl opacity-30 animate-pulse"></div>
                ...
                <div className="text-center max-w-md mx-auto">
                    ...
                    {onStartSubmission && (
                        <Button
                            ...
                            className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white px-6 py-3 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 inline-flex items-center gap-2"
                        >
                ...
                <div className="absolute bottom-4 left-4 w-20 h-20 bg-indigo-400/10 rounded-full blur-2xl"></div>
            </div>
        </div>
    );
}
