        ...
        {loading ? (
          <div className="relative py-16 px-6">
            ...
            <div className="relative">
              ...
              <div className="max-w-md mx-auto bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-blue-200 p-8">
                {/* Pulsing icon */}
                <div className="flex justify-center mb-6">
                  <div className="relative">
                    <div className="w-20 h-20 bg-gradient-to-br from-blue-600 to-indigo-600 rounded-full flex items-center justify-center animate-pulse">
          ...
          <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
              {images.map((img, index) => (
                <div
                  key={index}
                  className="group relative bg-white rounded-xl border-2 border-gray-200 hover:border-blue-400 transition-all duration-300 overflow-hidden shadow-sm hover:shadow-lg"
                >
                  {/* Image Badge */}
                  <div className="absolute top-2 left-2 z-10 bg-blue-600 text-white text-xs font-bold px-2 py-1 rounded-md shadow-md">
                    #{index + 1}
                  </div>
                  ...
                  <div className="p-3 sm:p-4 bg-white">
                    <div className="grid grid-cols-3 gap-2">
                      ...
                      <button
                        ...
                        className="flex flex-col items-center gap-1 p-2 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 hover:from-blue-100 hover:to-indigo-100 border border-blue-200 hover:border-blue-400 transition-all duration-200 group/btn"
                        title="Edit image"
                      >
                        <Edit3 className="w-4 h-4 text-blue-600 group-hover/btn:scale-110 transition-transform" />
                        <span className="text-[10px] sm:text-xs font-medium text-blue-700">Edit</span>
                      </button>
                      ...
                      >
                        <Eye className="w-4 h-4 text-green-600 group-hover/btn:scale-110 transition-transform" />
                        <span className="text-[10px] sm:text-xs font-medium text-green-700">View</span>
                      </button>
                      ...
                      >
                        ...
                        <span className="text-[10px] sm:text-xs font-medium text-purple-700">Save</span>
                      </button>
                    </div>
