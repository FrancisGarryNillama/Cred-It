        ...
        <div className="flex items-center justify-between bg-white rounded-xl border border-gray-200 p-4 sm:p-5">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="p-2 sm:p-3 rounded-lg border-2 border-gray-300 hover:border-blue-500 hover:bg-blue-50 disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:border-gray-300 disabled:hover:bg-transparent transition-all"
            >
                  ...
                  return (
                    <button
                      ...
                      className={`min-w-[44px] sm:min-w-[52px] h-11 sm:h-13 px-3 sm:px-4 rounded-lg font-bold text-base sm:text-lg transition-all ${isActive
                        ...
                        : 'border-2 border-gray-300 text-gray-700 hover:border-blue-500 hover:bg-blue-50'
                        }`}
                    >
                      {pageNum}
                    </button>
